...
- If the computation is too heavy for your system or it takes too long, you can adjust shift resolution.
- *Adjustments should be made with care.*

## Data preparation
- The input and reference spectrum should be normalized before they can be used this pipeline.
...
## Reference spectrum
- Must contain exactly two columns, one header row, and spectrum data starts from row 1.
- The first column is wavelength while the second column is intensity.

## Input (uncalibrated) spectrum
- Contains two or more columns, one header row, and spectrum data starts from row 1.
